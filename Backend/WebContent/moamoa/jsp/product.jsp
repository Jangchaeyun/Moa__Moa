  ...
  <%--  <jsp:include page="menu.jsp"/> --%>
   ...
   <div class="container">
      <div class="row">
         ...
         <div class="col-md-6">
            <h3><%=product.getMealkit_num() %></h3>
            <p><%=product.getMain_ingredient() %></p>
            <p><b>상품 이름 :</b><span class="badge badge-danger" ><%=product.getMealkit_title() %><span></b></p>
            <p><b>분류 : </b><%=product.getMain_ingredient() %></p>
