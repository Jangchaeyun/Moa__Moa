                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="header__top__right">
                                ...
                                <div class="header__top__right__auth">
                                    <a href="../운영자로그인회원가입페이지/op_login.html">
                                        운영자</a>
                                </div>
                                <div class="header__top__right__auth">
                                    <a>
            ...
            <h2 class="subtitle" id="sub1"style="padding-top:100px !important; ">검색 결과</h2>
				...
				<br>
					<%for(int i=0; i<presult.size(); i++){%>
						 <tr><a href="postDetail.jsp?postTitle=<%= presult.get(i).getTitle()%>"><%=presult.get(i).getTitle() %></a></tr>
					     <tr><%=presult.get(i).getDate() %></tr>
					     <tr><%=presult.get(i).getContent() %></tr>
					     <br>
					<%	 
					} 
					%>
				...
				<br>
					<%for(int i=0; i<mresult.size(); i++){%>
						 <tr><a href="product.jsp?productTitle=<%= mresult.get(i).getMealkit_title() %>"><%=mresult.get(i).getMealkit_title() %></a></tr>
					     <tr><%=mresult.get(i).getMain_ingredient() %></tr>
					     <tr><%=mresult.get(i).getMealkit_content() %></tr>
					     <tr><%=mresult.get(i).getMealkit_price() %></tr>
					     <br>
					<%	 
					} 
					%>
